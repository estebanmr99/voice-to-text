...
For `v0.1.0`, the canonical public release body lives in `docs/releases/v0.1.0.md` and should replace autogenerated notes after assets are attached:
...
- [ ] Release notes drafted in `docs/releases/v0.1.0.md` and applied with `gh release edit v0.1.0 --notes-file docs/releases/v0.1.0.md`
- [ ] GitHub release created or updated at [GitHub Releases](https://github.com/estebanmr99/voice-to-text/releases)
